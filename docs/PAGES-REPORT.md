...
| `GET/POST /api/experience`                  | _(Removed — was AI experience stub)_ |
| `GET/POST /api/gemini`                      | _(Removed — was Gemini chat)_        |
...
_Generated from the codebase. Update this report when adding or removing routes._
