...
async function main() {
  ...
  const premiumPackages = await Promise.all([
    prisma.premiumPackage.upsert({
      ...
      create: {
        id: 'essenza',
        name: 'Essenza',
        description: 'Lo básico, pero nunca aburrido',
        price: 350,
        features: ['Guía esencial con recomendaciones simples'],
        sortOrder: 1,
      },
    }),
    prisma.premiumPackage.upsert({
      ...
      create: {
        ...
        name: 'Modo Explora',
        description:
          'Para los que creen que descubrir es un verbo en movimiento',
        price: 500,
        features: ['Guía "Randomtrip Decode" curada con pistas y actividades'],
        sortOrder: 2,
      },
    }),
    prisma.premiumPackage.upsert({
      ...
      create: {
        ...
        price: 1200,
        features: ['Concierge personal', 'Experiencias exclusivas'],
        sortOrder: 5,
      },
    }),
  ]);
  ...
  const tripper = await prisma.tripper.upsert({
    ...
    create: {
      ...
      coverImage: '/images/trippers/ale-hero.jpg',
      tierLevel: 'ELITE',
