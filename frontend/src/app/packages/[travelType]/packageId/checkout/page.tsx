...
const CheckoutPage = () => {
  ...
  const [totalPrice, setTotalPrice] = useState(1500); // Placeholder, replace with actual calculation from context
  const [pricePerPerson, setPricePerPerson] = useState(750); // Placeholder, replace with actual calculation from context
  const [travelers, setTravelers] = useState(2); // Placeholder, replace with actual value from context
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <AppleCard className="mb-8">
          ...
          <div className="space-y-4 text-gray-700 mb-6">
            ...
            {/* Add more summary details here based on previous steps (origin, dates, filters, addons) */}
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-yellow-500 text-gray-900 font-bold py-3 px-4 rounded-md hover:bg-yellow-600 transition-colors duration-300"
            >
              Pagar con PayPal
            </button>
          </div>
