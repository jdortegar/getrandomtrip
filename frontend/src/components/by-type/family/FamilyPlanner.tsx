    ...
    () => [
      {
        ...
        bullets: [
          ...
          'Extras: Guía esencial para que todos disfruten sin complicaciones.',
          '📝 Lo básico para que todos disfruten sin estrés: un par de días que se contarán en la sobremesa.',
        ],
        cta: 'Reservar fácil →',
      },
      {
        ...
        bullets: [
          ...
          'Extras: Guía Randomtrip Decode con actividades pensadas para todas las edades.',
          '📝 Actividades pensadas para todas las edades, con planes que sorprenden a grandes y chicos.',
        ],
      ...
      },
      {
        ...
        bullets: [
          ...
          '📝 Más días, más juegos, más historias que terminan heredándose.',
        ],
        cta: 'Suban de nivel →',
      },
      {
        ...
        bullets: [
          ...
          '📝 Un viaje curado con detalle, donde cada miembro de la familia encuentra su lugar.',
        ],
        cta: 'Viajen distinto →',
      },
      {
        ...
        bullets: [
          ...
          'Extras: Co-creación con Luxury Travel Advisor + equipo 24/7. Incluye 2+ experiencias premium familiares, perks (traslados privados, salas VIP, reservas prioritarias, atenciones exclusivas).',
