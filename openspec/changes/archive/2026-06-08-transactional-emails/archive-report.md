...
| Archive Report | (persisted separately) | `sdd/transactional-emails/archive-report` |

### OpenSpec (Files)

| Artifact | Path |
|---|---|
| Proposal | `openspec/changes/archive/2026-06-08-transactional-emails/proposal.md` |
| Spec | `openspec/changes/archive/2026-06-08-transactional-emails/spec.md` |
| Design | `openspec/changes/archive/2026-06-08-transactional-emails/design.md` |
| Tasks | `openspec/changes/archive/2026-06-08-transactional-emails/tasks.md` |
| Verify Report | `openspec/changes/archive/2026-06-08-transactional-emails/verify-report.md` |
| Archive Report | `openspec/changes/archive/2026-06-08-transactional-emails/archive-report.md` |
| State | `openspec/changes/archive/2026-06-08-transactional-emails/state.yaml` |
...
- **Archive**: DONE — change folder moved to archive

Folder now at: `openspec/changes/archive/2026-06-08-transactional-emails/`
