...
const MOCK_EXPERIENCES: MockExperience[] = [
  // COUPLE
  {
    ...
    teaser:
      "Colinas verdes, viñedos y una escapada romántica sin itinerario fijo.",
    description:
      "<p>Un fin de semana para dos en pleno corazón de la Toscana. Alojamiento boutique, cena privada y paseo entre viñedos.</p>",
  ...
  },
  {
    ...
    teaser:
      "Calles empedradas, fado al atardecer y el mejor pastel de nata de tu vida.",
    description:
      "<p>Tres noches en Lisboa con experiencias locales seleccionadas para parejas curiosas. Sin guías turísticos, solo la ciudad.</p>",
  ...
  // FAMILY
  {
    ...
    title: "Patagonia KIN",
    teaser:
      "Aventura familiar en el fin del mundo: glaciares, lagos y senderos para todos.",
    description:
      "<p>Cuatro noches en la Patagonia argentina diseñadas para familias con niños. Actividades al aire libre con guías especializados.</p>",
  ...
  // GROUP
  {
    ...
    teaser:
      "Ciudad amurallada, playas caribeñas y una semana de experiencias grupales únicas.",
    description:
      "<p>Siete días en Cartagena de Indias para grupos de amigos. Alojamiento en casa colonial, tour gastronómico y día de playa en Islas del Rosario.</p>",
  ...
  },
  {
    ...
    teaser:
      "Entre montañas y bodegas: una experiencia premium para grupos exigentes.",
    description:
      "<p>Cinco noches en Mendoza con catas privadas, trekking en Los Andes y gastronomía de autor para grupos de hasta 8 personas.</p>",
  ...
  // SOLO
  {
    ...
    title: "Tokio SOLUM",
    teaser:
      "Una semana en Tokio diseñada para viajeros solitarios que quieren ir más allá del turismo.",
    description:
      "<p>Siete días en Tokio con acceso a experiencias locales auténticas: talleres de soba, onsen privado y tour de izakayas fuera de los circuitos turísticos.</p>",
  ...
  },
  {
    ...
    teaser:
      "Arte, mezcal y cocina ancestral para el viajero solitario que busca autenticidad.",
    description:
      "<p>Dos noches en Oaxaca con cena en mercado local, visita a un taller de barro negro y clase de cocina tradicional.</p>",
  ...
  // HONEYMOON
  {
    ...
    teaser:
      "Una luna de miel sin igual: villa sobre el agua, buceo y cena privada al atardecer.",
    description:
      "<p>Siete noches en Maldivas en villa overwater con desayuno incluido, snorkel privado en arrecife de coral y masaje de parejas en la playa.</p>",
  ...
  },
  {
    ...
    teaser:
      "Castillos medievales, olivos milenarios y una boda privada en viñedo.",
    description:
      "<p>Cinco noches en la campiña toscana: alojamiento en castillo restaurado, cena de bienvenida con sommelier y paseo en globo al amanecer.</p>",
  ...
  // PAWS
  {
    ...
    teaser:
      "Trekking, lagos y montañas para vos y tu mejor compañero de cuatro patas.",
    description:
      "<p>Tres noches en la Patagonia con alojamiento pet-friendly, senderismo con perros permitido y guía especializado en viajes con mascotas.</p>",
  ...
  },
  {
    ...
    teaser:
      "Canales, cafés dog-friendly y una ciudad que ama a los perros tanto como vos.",
    description:
      "<p>Dos noches en Amsterdam con alojamiento que admite mascotas, city bike tour dog-friendly y cena en restaurante pet-welcome.</p>",
...
async function upsertExperience(exp: MockExperience, ownerId: string) {
  ...
  return prisma.experience.create({
    data: { slug: exp.slug, ownerId, ...data },
  });
}
