...
interface Props {
  copy: AppDictionary["adminBlogReview"];
...
/** Approve/reject/start-edit/send/discard decision bar for the blog review screen — the blog analogue of AdminReviewActionsBar, minus pricing (blogs have no price gate). */
export function AdminBlogReviewActionsBar({
  copy,
  activeSaving,
  adminCopyId,
  error,
