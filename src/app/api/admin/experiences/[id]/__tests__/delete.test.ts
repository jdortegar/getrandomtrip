...
const findExperience = prisma.experience.findUnique as ReturnType<typeof vi.fn>;
const deleteIfAllowed = deleteExperienceIfAllowed as ReturnType<typeof vi.fn>;

const call = () =>
  DELETE(new NextRequest("http://localhost/api/admin/experiences/e1", { method: "DELETE" }), {
...
describe("DELETE /api/admin/experiences/[id]", () => {
  beforeEach(() => {
    ...
    findUser.mockResolvedValue({ id: "u1", roles: ["ADMIN"] });
