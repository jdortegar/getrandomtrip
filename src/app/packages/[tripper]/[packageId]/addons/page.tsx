...
const allAddons: Addon[] = [
  ...
  {
    id: 'equipaje-documentado',
    title: 'Equipaje documentado',
    description: '',
    price: 25,
    costType: 'per_person',
  },
  {
    id: 'esims',
    title: 'eSIMs (Digital Packs)',
    description: '',
    price: 25,
    costType: 'per_person',
  },
  {
    id: 'upgrade-alojamiento',
    title: 'Upgrade de Alojamiento / Habitación',
    description: 'Por persona por noche',
    price: 50,
    costType: 'per_person',
  }, // Assuming per night, needs nights from pkg
  {
    id: 'desayuno-hotel',
    title: 'Desayuno en Hotel',
    description: 'Por persona por día',
    price: 15,
    costType: 'per_person',
  }, // Assuming per day, needs days from pkg
  {
    id: 'apu-destino',
    title: 'APU en destino (recogida en aeropuerto a la llegada)',
    description: 'Precio fijo por reserva',
    price: 30,
    costType: 'per_reservation',
  },
  {
    id: 'ado-destino',
    title: 'ADO en destino (llevarlos al aeropuerto para regresar a casa)',
    description: 'Precio fijo por reserva',
    price: 30,
    costType: 'per_reservation',
  },
  {
    ...
    title: 'Alquiler de vehículo en destino',
    description: 'Precio fijo por reserva por día',
    price: 50,
    costType: 'per_reservation',
  }, // Assuming per day, needs days from pkg
  {
    id: 'experiencia-destino',
    title: 'Experiencia en destino',
    description: '',
    price: 50,
    costType: 'per_person',
  },
  {
    id: 'randomtrip-advisor-decode',
    title: 'Randomtrip Advisor Decode (Guia y tips personalizada)',
    description: 'Precio fijo por reserva',
    price: 20,
    costType: 'per_reservation',
  },
...
const AddonsPage = () => {
  ...
  const grandTotal =
    filtersCostPerPerson * travelers + calculateAddonCosts.totalAddonCost;
        ...
        <AppleCard className="mb-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="border-t border-gray-200 pt-6 mt-8">
              ...
              <p className="text-gray-700 mb-2">
                Costo extra por persona: $
                {calculateAddonCosts.addonCostPerPerson.toFixed(2)} USD
              </p>
              <p className="text-gray-700 mb-4">
                Costo extra total: $
                {calculateAddonCosts.totalAddonCost.toFixed(2)} USD
              </p>
              <div className="border-t border-gray-200 my-4"></div>
              <p className="text-lg font-semibold text-gray-800 mb-2">
                Filtros + add-ons por persona: ${totalPerPerson.toFixed(2)} USD
              </p>
              <p className="text-lg font-semibold text-gray-800 mb-4">
                Filtros + add-ons total: ${grandTotal.toFixed(2)} USD
              </p>
