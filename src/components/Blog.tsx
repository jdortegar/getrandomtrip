...
export default function Blog({
  ...
  return (
    <Section id={id} variant="dark" className="overflow-hidden">
      <div className="max-w-5xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          ...
          {/* Content Section - Gallery extends beyond container */}
          <div className="md:col-span-2 -mr-[50vw] md:pr-0">
            <div
            ...
            >
              ...
              {showViewAll && content.viewAll && (
                <Link href={content.viewAll.href} className="mr-[50vw]">
