...
export const PrevButton = (props: PropType) => {
  ...
  return (
    <button
      ...
      className={cn(
        buttonBaseClass,
        "h-8 w-8 bg-primary text-white hover:bg-primary-800 md:h-10 md:w-10 flex items-center justify-center disabled:bg-primary/40 disabled:pointer-events-none",
        className,
      )}
      disabled={disabled}
      type="button"
