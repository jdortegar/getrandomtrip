...
export function XsedDinnerStep({
  form,
  onChange,
  copy,
  sectionsCopy,
  ...
  function updateContact(patch: Partial<XsedSection["contact"]>) {
    const current = form.sections[1] ?? EMPTY_XSED_SECTION;
  ...
  return (
    <div className="space-y-6" data-component="XsedDinnerStep">
      ...
      <XsedContactFields
        idPrefix="xsed-dinner"
        contact={(form.sections[1] ?? EMPTY_XSED_SECTION).contact}
