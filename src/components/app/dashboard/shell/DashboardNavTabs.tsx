          ...
          return (
            <Link
              ...
              className={cn(
                ...
                TAB_MIN_HEIGHT,
                active
                  ? "bg-secondary text-white shadow-md focus-visible:ring-white"
                  : "bg-white text-gray-500 shadow-sm ring-1 ring-gray-100 hover:text-gray-700 hover:shadow-md focus-visible:ring-secondary",
              )}
              href={tab.href}
            >
