    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-4">
        <FormField
          ...
          onBlur={() => { if (form.minPax < 1) onChange('minPax', 1); }}
        />
        <FormField
          id="cap-max-pax"
          ...
          onBlur={() => { if (form.maxPax < 1) onChange('maxPax', 1); }}
        />
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <FormField
          ...
          onBlur={() => { if (form.minNights < 1) onChange('minNights', 1); }}
        />
        <FormField
          id="cap-max-nights"
          ...
          onBlur={() => { if (form.maxNights < 1) onChange('maxNights', 1); }}
        />
      </div>
