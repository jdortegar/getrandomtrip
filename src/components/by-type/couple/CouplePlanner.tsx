...
export default function CouplePlanner() {
    ...
    <div className="sticky top-0 z-[1] bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-6 text-center">
        ...
        <ol className="mt-4 flex justify-center gap-3 text-sm text-neutral-600">
          <li
            className={
              step === 'Presupuesto' ? 'font-semibold text-neutral-900' : ''
            }
          >
            Presupuesto
          </li>
          ...
          <li
            className={
              step === '🌟 La Excusa' ? 'font-semibold text-neutral-900' : ''
            }
          >
            🌟 La Excusa
          </li>
          ...
          <li
            className={
              step === 'Afinar detalles' ? 'font-semibold text-neutral-900' : ''
            }
          >
            Afinar detalles
          </li>
  ...
  const Intro = () => (
    <section
      data-testid="couple-planner"
      className="max-w-7xl mx-auto px-4 md:px-8 py-12"
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
        <div>
          <h3 className="text-xl font-semibold text-neutral-900">
            Viajar en pareja tiene sus códigos{' '}
            <span className="text-neutral-600">(y los entendemos)</span>
          </h3>
          <p className="mt-3 text-neutral-800">
            Sin planillas, sin discusiones eternas: ustedes traen la historia;
            nosotros ponemos el escenario. Lo básico se resuelve en minutos. Lo
            inolvidable, lo viven ustedes.
          </p>
        ...
        <aside className="md:pl-6 text-neutral-900 leading-relaxed">
          <p className="mb-3">
            Diseñamos viajes que funcionan para parejas reales: con tiempos
            distintos, presupuestos mezclados y ganas de sorprenderse en común.
          </p>
          <p className="mb-3">
            Ustedes traen la historia; nosotros la transformamos en escenario:
            sin fricciones logísticas, con experiencias que conectan y la dosis
            justa de misterio.
          </p>
          <p className="mb-3">
            Porque cuando lo compartido se diseña bien, cada recuerdo se escribe
            en mayúsculas.
          </p>
        </aside>
      </div>
      ...
      {step === 'Presupuesto' && (
        ...
        >
          <div className="text-center mb-8">
            ...
            >
              💡 Lo único que definen acá es el presupuesto por persona para
              pasaje y alojamiento. Ese será su techo. Del resto… nos ocupamos
              nosotros.
            </h3>
          </div>
            ...
            {tiers.map((t) => (
              ...
              >
                ...
                <div className="flex-1 flex flex-col">
                  <h4
                    id={`h-${t.id}`}
                    className="font-display text-xl tracking-tightish font-bold text-gray-900"
                  >
                    {t.name}
                  </h4>
                  ...
                  <ul className="mt-5 space-y-2 text-sm text-gray-800">
                    {(t.features ?? []).map((f, i) => (
                      <li key={i} className="leading-snug">
                        ...
                        {f.footnote && (
                          <span className="block pl-4 text-xs text-gray-600">
                            * {f.footnote}
                          </span>
                        )}
                      </li>
      ...
      {step === '🌟 La Excusa' && (
        ...
        >
          <div className="text-center mb-8">
            ...
            >
              Toda escapada tiene su “porque sí”. Armando el 🌟 Destination
              Decoded.
            </p>
          </div>
