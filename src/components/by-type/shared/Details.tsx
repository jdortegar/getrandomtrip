...
const BORDER_COLOR: Record<string, string> = {
  ...
  'solo-get-lost': 'border-emerald-400',
  'solo-busqueda-interior': 'border-teal-400',
  'solo-aventura-desafio': 'border-cyan-400',
  'solo-exploracion-cultural': 'border-amber-400',
  'solo-fotografia-narrativa-visual': 'border-violet-400',
  'solo-literatura-arte-talleres': 'border-orange-400',
  'solo-musica-sonidos': 'border-pink-400',
  'solo-tribe-encounters': 'border-sky-400',
  // Family excuse keys
