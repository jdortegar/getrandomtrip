    ...
    <div className="mt-4 space-y-4">
      ...
      <div>
        ...
        <input
          ...
          value={logistics.city?.name ?? ''}
          onChange={(e) =>
            setPartial({
              logistics: {
                ...logistics,
                city: { ...(logistics.city || {}), name: e.target.value },
              },
            })
          }
      ...
      {logistics.nights > 0 && (
        <p className="text-sm text-gray-600">Duración: {logistics.nights} noches</p>
      )}
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) =>
            setPartial({
              logistics: { ...logistics, pax: parseInt(e.target.value, 10) || 1 },
            })
          }
          className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
        />
