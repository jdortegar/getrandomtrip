...
export default function NewsletterBar() {
  ...
  return (
    <div
      ...
      className="fixed inset-x-0 bottom-0 z-50 border-t border-white/10 bg-neutral-900/95 backdrop-blur supports-backdrop-filter:backdrop-blur-md text-white" data-component="NewsletterBar"
    >
