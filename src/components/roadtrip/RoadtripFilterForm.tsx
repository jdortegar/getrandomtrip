...
export default function RoadtripFilterForm() {
  ...
  const types = [
    {
      id: "nature",
      title: "Paisajes & Naturaleza",
      desc: "Montañas, lagos, cielos abiertos.",
    },
    {
      id: "culture",
      title: "Cultura Urbana & Street",
      desc: "Ritmo, arte, barrios y escenas vivas.",
    },
    {
      id: "wildlife",
      title: "Wildlife & Fauna",
      desc: "Encuentros con fauna en su hábitat.",
    },
    {
      id: "drone",
      title: "Drone & Panorámicas",
      desc: "Perspectivas aéreas y horizontes amplios.",
    },
  ];
  const [selectedType, setSelectedType] = useState<string>("nature");

  // TAB 3 — afinar detalles (placeholder simples para demo)
  const [pace, setPace] = useState<"relax" | "balanced" | "intense">(
    "balanced",
  );
  const [budgetLevel, setBudgetLevel] = useState<
    "smart" | "comfort" | "premium"
  >("comfort");
      ...
      <div className="rounded-2xl border border-black/5 bg-white p-6 shadow-sm">
        ...
        {step === 2 && (
          <div className="space-y-6">
            ...
            <p className="text-gray-600">
              Elegí el tipo de roadtrip que mejor les va.
            </p>
