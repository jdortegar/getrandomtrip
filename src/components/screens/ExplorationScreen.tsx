...
const travellerTypes = [
  {
    type: 'couple',
    title: '¿Con quién vas a escribir tu próxima historia?',
    description: 'Escapadas románticas e inolvidables.',
    imageUrl: '/images/placeholder-couple.svg',
  },
  {
    type: 'solo',
    title: 'Viajar solo no es aburrido, es liberador',
    description: 'Descúbrete a ti mismo en un viaje único.',
    imageUrl: '/images/placeholder-solo.svg',
  },
  {
    type: 'family',
    title: '¿Hora de aventuras en familia?',
...
const roadtripTypes = [
  {
    ...
    bgImage: 'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf',
  },
  {
    type: 'Motorcycle',
    icon: '🏍️',
    description: 'Siente el camino y el viento.',
    bgImage: 'https://images.unsplash.com/photo-1558981403-c5f9899a28bc',
  },
  {
    type: 'Bike',
    icon: '🚲',
    description: 'Una aventura a tu propio ritmo.',
    bgImage: 'https://images.unsplash.com/photo-1471506480396-160b2734bf77',
  },
];
...
const decodeData = [
  {
    ...
    month: 'Enero',
    bg: 'https://images.unsplash.com/photo-1621431213292-31434c898822',
    profileImg: 'https://i.pravatar.cc/150?u=ana',
  ...
  },
  {
    destination: 'Kyoto',
    month: 'Abril',
    bg: 'https://images.unsplash.com/photo-1524413840807-0c3cb6fa808d',
    profileImg: 'https://i.pravatar.cc/150?u=julian',
    ...
    <div className="bg-[#0D0D0D] text-white py-16">
      <div className="rt-container px-4 md:px-8">
        <div className="text-center">
          ...
          <p
            className="text-lg text-gray-400 mt-4 mb-12"
        ...
        <div className="animate-fade-in">
          ...
          {activeTab === 'Trippers Decode' && (
            <div>
              <p className="text-center text-gray-400 mb-8 italic max-w-2xl mx-auto">
                {t('trippersDecodeSubtitle')}
              </p>
