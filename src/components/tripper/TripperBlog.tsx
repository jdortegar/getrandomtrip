...
export default function TripperBlog({
  ...
  return (
    <section id={sectionId} className="py-20 px-8 bg-primary text-white scroll-mt-24">
        ...
        <div className="md:col-span-2">
          <div className="flex overflow-x-auto space-x-8 pb-8 hide-scrollbar">
            {items.map((p: { title: string; image: string; category: string }) => (
              <div key={p.title} className="w-80 shrink-0 transition hover:-translate-y-0.5 hover:shadow-lg">
