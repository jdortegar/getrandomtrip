export default function TripperClosing() {
  const benefits = [
    ...
    {
      t: "Sorpresa bien diseñada",
      d: "Momentos memorables, sin improvisación.",
    },
  ];
  return (
    <section className="py-16 bg-primary text-white border-t border-gray-700" data-component="TripperClosing">
