...
export default function TripperTestimonials({
  testimonials = [] as { author: string; quote: string }[],
}) {
  if (!testimonials.length) return null;
  return (
    <section className="py-16 bg-gray-800 text-white" data-component="TripperTestimonials">
