...
const argentina: CountryCopy = {
  ...
  reasonsToGo: [
    ...
    "Bodegas de garaje y mesas largas",
    "Estancias con cielo interminable",
    "Iguazú desde pasarelas secretas",
    "Barrios creativos en Buenos Aires",
  ],
  bestFor: ["Aventura", "Gastronomía", "Naturaleza", "Lujo", "Parejas"],
  whenToGo: [
    { months: "Sep–Nov", why: "primavera suave en ciudades y viñedos" },
    { months: "Dic–Mar", why: "Patagonia abierta y lagos navegables" },
    { months: "Abr–May", why: "vendimias y calor amable en Cuyo" },
  ],
  signatureExperiences: [
    "Trekking sobre el Glaciar Perito Moreno",
    "Asado al asador en una estancia patagónica",
    "Cata privada en bodega boutique de Mendoza",
    "Cabalgata al atardecer en la pampa",
    "Clase de tango en un salón histórico de San Telmo",
  ...
  gallery: [
    "/images/bitacoras/argentina-gallery-1.jpg",
