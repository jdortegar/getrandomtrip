...
const haiti: CountryCopy = {
  ...
  reasonsToGo: [
    ...
    "El vibrante y único arte haitiano",
    "La profunda historia de la primera república negra del mundo",
    "La espiritualidad y las tradiciones del vudú",
    "Paisajes montañosos y playas por descubrir",
  ],
  ...
  signatureExperiences: [
    ...
    "Explorar las ruinas del Palacio de Sans-Souci",
    "Visitar los talleres de los artistas del metal en Croix-des-Bouquets",
    "Asistir a una ceremonia vudú (con el debido respeto y guía)",
