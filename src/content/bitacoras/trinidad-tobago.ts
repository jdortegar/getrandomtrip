...
const trinidadAndTobago: CountryCopy = {
  ...
  reasonsToGo: [
    ...
    "La tranquila y paradisíaca isla de Tobago",
    "La increíble biodiversidad y el avistamiento de aves en Trinidad",
    "La invención del steelpan (tambor metálico)",
    "Una mezcla cultural única de influencias indias, africanas y europeas",
  ],
  ...
  signatureExperiences: [
    ...
    "Visitar el Asa Wright Nature Centre para el avistamiento de aves",
    "Relajarse en las playas de Tobago, como Pigeon Point",
    "Hacer un tour en barco por el Caroni Swamp para ver el ibis escarlata",
