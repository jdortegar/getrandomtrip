...
export const familyEn: TravelerTypeData = {
    ...
    levels: [
      {
        ...
        closingLine:
          "A family getaway with the essentials, no stress, so everyone enjoys.",
        ctaLabel: "Book easy",
      ...
      },
      {
        ...
        closingLine:
          "More days, more activities, more lasting memories for the whole family.",
      ...
      },
      {
        ...
        closingLine:
          "A made-to-measure experience where the whole family travels as the main character.",
  ...
  testimonials: {
    ...
    items: [
      {
        quote:
          "Everyone enjoyed it, from the youngest to the grandparents. Very well balanced.",
        author: "The Gómez Family",
        country: "Argentina",
      },
      {
        quote:
          "Activities for all ages. You can tell they thought through every detail.",
        author: "The López Family",
        country: "Argentina",
      },
      {
        quote:
          "The kids wanted to stay one more day. Beautiful memories for everyone.",
        author: "The Fernández Family",
        country: "Argentina",
      },
      {
        quote:
          "Flexibility without losing structure. Easy to get around with the little ones.",
      ...
      {
        quote:
          "We discovered places we wouldn’t have found on our own. Great experience.",
