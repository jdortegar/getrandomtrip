...
export const groupEn: TravelerTypeData = {
    ...
    levels: [
      {
        ...
        features: [
          ...
          },
          {
            title: "Benefits",
            description:
              "Essential guide with simple recommendations for the group.",
          },
        ],
        closingLine:
          "A simple getaway to sync schedules, so you only worry about enjoying together.",
      ...
      },
      {
        ...
        features: [
          ...
          },
          {
            title: "Benefits",
            description:
              "Randomtrip guide with activities and suggestions for different paces within the group.",
          },
        ],
        closingLine:
          "For groups who want to explore at their own pace, with the flexibility they need.",
      ...
      },
      {
        ...
        closingLine:
          "More days, more activities, more stories that become shared legend.",
        ctaLabel: "Level up",
        excuses: [
          {
            key: "default-excuse",
      ...
      },
      {
        ...
        closingLine:
          "A unique group experience with details that make the difference.",
      ...
      },
      {
        ...
        closingLine:
          "The experience that turns any celebration into unforgettable.",
  ...
  testimonials: {
    ...
    items: [
      {
        quote:
          "They organized everything perfectly for our group of 10. Zero conflict, pure fun.",
        author: "BA Friends Group",
        country: "Argentina",
      },
      {
        quote:
          "Everyone could do their own thing without missing the group vibe. Great balance.",
      ...
      {
        quote:
          "Surprises perfectly calibrated for the group. Highly recommended.",
        author: "Squad Lima",
        country: "Peru",
      },
    ] as Testimonial[],
