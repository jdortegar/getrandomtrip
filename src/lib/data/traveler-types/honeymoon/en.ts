...
export const honeymoonEn: TravelerTypeData = {
    ...
    levels: [
      {
        ...
        features: [
          { title: "Duration", description: "2 nights" },
          { title: "Destinations", description: "Domestic cities" },
          {
            title: "Transport",
            description: "Low cost (buses or off-peak flights).",
            footnote:
              "Seat selection, carry-on and checked baggage not included.",
          },
          {
            title: "Dates",
            description:
              "Limited availability, with restrictions and blackouts.",
          },
          {
            title: "Accommodation",
            description: "Midscale (3★ or equivalent).",
          },
      ...
      },
      {
        ...
        priceFootnote: "per person",
        features: [
          { title: "Duration", description: "4 nights" },
          { title: "Destinations", description: "Domestic + Regional" },
          { title: "Transport", description: "Economy with upgrade options." },
          {
            title: "Dates",
            description: "More flexibility, some restrictions.",
          },
          {
            title: "Accommodation",
            description: "Midscale+ (3-4★ or equivalent).",
          },
          {
            title: "Extras",
            description: "Destination guide + 1 experience included.",
          },
      ...
      },
      {
        ...
        priceFootnote: "per person",
        features: [
          { title: "Duration", description: "7 nights" },
          {
            title: "Destinations",
            description: "International + Premium domestic",
          },
          { title: "Transport", description: "Premium with full comfort." },
          {
            title: "Dates",
            description: "Maximum flexibility, no restrictions.",
          },
          { title: "Accommodation", description: "Luxury (5★ or equivalent)." },
          {
            title: "Extras",
            description: "Personalized guide + exclusive experiences.",
          },
          {
            title: "Benefits",
            description: "24/7 concierge + automatic upgrades",
          },
        ],
      ...
      },
      {
        ...
        priceFootnote: "per person",
        features: [
          { title: "Duration", description: "5 nights" },
          { title: "Destinations", description: "All Americas (no limits)" },
          {
            title: "Transport",
            description: "Multimodal with comfort prioritized.",
          },
  ...
  testimonials: {
    ...
    items: [
      {
        quote:
          "The perfect honeymoon. Everything was magical from the first moment.",
        author: "María & Juan",
        country: "Argentina",
      },
      {
      ...
      {
        quote:
          "Exceeded our expectations. We started our life together in the best way.",
        author: "Ana & Diego",
        country: "Spain",
      },
      {
