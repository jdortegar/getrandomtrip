...
export const pawsEn: TravelerTypeData = {
    ...
    levels: [
      {
        ...
        features: [
          ...
          {
            title: "Accommodation",
            description: "Comfort (3★) - Functional and pet-friendly",
          },
          {
            title: "Benefits",
            description: "Essential guide with pet-friendly map",
          },
        ],
        closingLine:
          "A simple escape where your pet isn't an extra—they're part of the plan.",
      ...
      },
      {
        ...
        features: [
          ...
          {
            title: "Accommodation",
            description: "+ Style (3-4★) - Elevate your stay, pet-friendly",
          },
          {
            title: "Benefits",
            description:
              "General guide + tips, with routes, play spots and pet-friendly activities.",
          },
        ],
        closingLine:
          "Trails and corners designed to discover with your companion, with freedom and no stress.",
      ...
      },
      {
        ...
        features: [
          ...
          },
          {
            title: "Benefits",
            description:
              "1 experience included (e.g. pet-friendly trail or day trip) + Destination Decoded guide",
          },
        ],
        closingLine:
          "More days, more play, more paw prints in the sand and in memory.",
        ...
        excuses: [
          {
            ...
            description:
              "The best of the best for an unforgettable experience.",
            img: "https://images.unsplash.com/photo-1469474968028-56623f02e42e",
            details: {
              title: "Premium Experience",
      ...
      },
      {
        ...
        priceFootnote: "per person\n+ pet",
        features: [
          { title: "Duration", description: "5 nights (No restrictions)" },
          {
            title: "Destinations",
          ...
          { title: "Transport", description: "Full flights (Maximum comfort)" },
          {
            title: "Accommodation",
            description:
              "+ Upper-scale (4-5★) - Design and service, pet-friendly",
          },
          {
            title: "Benefits",
            description:
        ...
        closingLine:
          "A premium trip, curated in detail for you and your four-legged companion.",
      ...
      },
      {
        ...
        closingLine:
          "An exclusive experience where every moment is designed for both of you.",
  ...
  testimonials: {
    ...
    items: [
      {
        quote:
          "My dog enjoyed it as much as I did. Amazing pet-friendly places.",
        author: "Lucía & Max",
        country: "Argentina",
      },
      {
      ...
      {
        quote:
          "We found beaches, parks and restaurants perfect for going with Toby.",
        author: "Ana & Toby",
        country: "Chile",
      },
      {
        quote:
          "My cat traveled comfortable and safe. Great experience for both.",
        author: "María & Michi",
        country: "Peru",
      },
      {
        quote:
          "Activities and accommodations ideal for traveling with our furry one.",
        author: "Juan & Rocky",
        country: "Argentina",
      },
      {
