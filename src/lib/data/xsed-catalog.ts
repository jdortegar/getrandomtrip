...
const XSED_LEVEL_ES: Level = {
  id: 'xsed',
  name: 'XSED Drop',
  description: 'Escapada sorpresa de un día — destino revelado el día del viaje.',
  color: 'bg-orange-500',
  maxNights: 1,
...
const XSED_LEVEL_EN: Level = {
  id: 'xsed',
  name: 'XSED Drop',
  description: 'One-day surprise escape — destination revealed on the day of travel.',
  color: 'bg-orange-500',
  maxNights: 1,
  price: XSED_PRICE_PER_PERSON,
  priceLabel: `${XSED_PRICE_PER_PERSON} USD`,
