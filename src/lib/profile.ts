...
const mock: Record<string, PublicProfile> = {
  'santi.user': {
    ...
    prefs: {
      lodging: 'Boutique / B&B',
      style: ['Café', 'Gastronomía', 'Trekking suave'],
      dailyBudgetUSD: 150,
    },
    socials: {
      ig: 'randomtrip.ig',
      yt: 'randomtrip.yt',
      web: 'getrandomtrip.com',
    },
    favorites: [
      {
        id: 'f1',
        title: 'Aventura en la Patagonia',
        image: '/images/journey-types/roadtrip-car.jpg',
        href: '/packages/build/add-ons',
      },
      {
        id: 'f2',
        title: 'Ruta del Café (CDMX)',
        image: '/images/journey-types/couple-hetero.png',
        href: '/packages/build/add-ons',
      },
    ],
    reviews: [
      {
        ...
        title: 'Ruta del Café',
        rating: 5,
        excerpt: 'Excelente curaduría y tiempos.',
      },
      {
        id: 'r2',
        title: 'Escapada al Viñedo',
        rating: 4,
        excerpt: 'Lugares hermosos.',
      },
    ],
    posts: [],
  },
