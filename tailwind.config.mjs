...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        glow: '0 0 0 1px hsl(var(--ring)), 0 0 20px hsl(var(--ring) / 0.3)',
        'glow-lg':
          '0 0 0 1px hsl(var(--ring)), 0 0 40px hsl(var(--ring) / 0.4)',
      },
      ...
      keyframes: {
        ...
        'pulse-glow': {
          '0%, 100%': {
            boxShadow:
              '0 0 0 1px hsl(var(--ring)), 0 0 20px hsl(var(--ring) / 0.3)',
          },
          '50%': {
            boxShadow:
              '0 0 0 1px hsl(var(--ring)), 0 0 40px hsl(var(--ring) / 0.6)',
          },
        },
      },
      animation: {
